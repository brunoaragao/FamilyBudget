...
public class GetIncomeByIdQueryValidatorTest
{
    ...
    {
        // Arrange
        var command = new GetIncomeByIdQuery(id);
    ...
    private static GetIncomeByIdQuery GetDefaultCommand()
    {
